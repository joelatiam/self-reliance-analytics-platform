...
ExecStart=/usr/bin/docker compose -f docker-compose.yml -f deploy/compose.prod.yml up -d --remove-orphans
ExecStop=/usr/bin/docker compose -f docker-compose.yml -f deploy/compose.prod.yml stop
